...
# --- 3. CONNECTION (AUTO-FIX KEY) ---
def get_connection():
    scopes = ["https://www.googleapis.com/auth/spreadsheets", "https://www.googleapis.com/auth/drive"]
    
    # 🔥 RAW KEY STRING (Direct from your JSON)
    # Hum isay code mein hi format karein ge taake koi ghalti na ho
    ...
    return client.open_by_url("https://docs.google.com/spreadsheets/d/14WmPIOtQSTjbx6zcOpGMHF2j27i_-hHkBI-9goLKV3c/edit")
...
def get_data(tab):
    try:
        ...
        st.error(f"❌ Read Error: {e} | Type: {type(e).__name__}")
        return pd.DataFrame()
...
def save_data(tab, data):
    try:
        ...
        st.error(f"❌ Save Error: {e} | Type: {type(e).__name__}")
        return False
