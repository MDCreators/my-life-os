...
# --- 2. CONNECTION (DIRECT KEY METHOD) ---
def get_connection():
    ...
    # 🔥 YEH HAI MAGIC FIX: Seedha ID se open karein gay
    # ID maine aap ki screenshot se li hai
    sheet_id = "1SQUmVySccnWz_G3ziZmiFB9Ry2thjxdnNGWvhppv-dE"
    return client.open_by_key(sheet_id)

# --- 3. HELPER FUNCTIONS ---
def get_worksheet_safe(client, tab_name):
    # Tab name safe fetcher
...
# === C. CLOSING ===
    ...
    with st.form("add_u"):
        ...
        if st.form_submit_button("Create"):
            try:
                client = get_connection()
                # Users sheet ID se nahi, open_by_key ke baad sheet object se mile gi
